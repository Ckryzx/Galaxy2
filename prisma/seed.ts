...
const clubs: ClubSeed[] = [
  ...
  },
  {
    ...
    colorHex: "#002d62",
    stars: [
      { name: "Cristián Zavala", position: Position.MID, price: 5.5 },
    ],
  ...
  },
  {
    ...
    colorHex: "#e30613",
    stars: [
      { name: "Sebastián Vegas", position: Position.DEF, price: 6.0 },
    ],
    fillerCount: { GK: 2, DEF: 6, MID: 6, FWD: 4 },
  },
  {
  ...
  },
  {
    ...
    colorHex: "#800080",
    stars: [
      { name: "Sebastián Vegas Jr.", position: Position.MID, price: 5.5 },
    ],
    fillerCount: { GK: 2, DEF: 6, MID: 6, FWD: 4 },
  },
  {
...
async function main() {
  ...
  console.log("Creando clubes y jugadores...");
