...
export function GoogleSignInButton() {
  return (
    <button
      ...
      className="flex w-full items-center justify-center gap-2 rounded-md border border-border bg-surface-alt py-2 font-semibold hover:bg-border transition-colors"
    >
